...
const curved = struct {
    ...
    pub const Params = geometry.curved.Params;
    pub const DistanceClip = geometry.curved.DistanceClip;
    pub const Screen = geometry.curved.Screen;
    pub const SampleStatus = geometry.curved.SampleStatus;
    pub const ProjectedSample = geometry.curved.ProjectedSample;
    pub const Vec3 = geometry.curved.Vec3;
    pub const AmbientFor = geometry.curved.AmbientFor;
    pub const Coords4 = geometry.curved.Coords4;
    ...
    pub const flatLerp3 = geometry.curved.flatLerp3;
    pub const ambientFromTypedTangentBasisPoint = geometry.curved.ambientFromTypedTangentBasisPoint;
    pub const sampleProjectedModelPoint = geometry.curved.sampleProjectedModelPoint;
...
const EuclideanVec3 = geometry.curved.Vec3;
